const translates = {
	...
	olhedao_faq: "关于天书",
	olhedao_faq_info: "<br>书写“天书”时，系统先从30个“天书”时机中随机筛选出三个，角色选择时机后，系统再从30个“天书”效果中随机筛选出三个效果等级和所选时机触发等级相同且可以和选择的时机匹配的效果，然后角色获得技能为你选择的“天书”时机+“天书”效果的〖天书〗，此技能被发动前对其余玩家不可见，发动两次时失去此〖天书〗。",
	olqingshu: "青书",
	...
	oljiaoyu: "椒遇",
	oljiaoyu_info: "锁定技，每轮开始时，你进行X次判定（X为你空置装备栏数），然后声明一种颜色并获得此颜色的判定牌，且本轮你的下回合结束时，你执行一个出牌阶段（你不能使用与声明颜色不同的牌），此阶段其他角色不能使用与你装备区牌颜色相同的牌直到有角色受到伤害时。",
	olneixun: "内训",
	...
	olshanjia: "缮甲",
	olshanjia_info: "①游戏开始时，你获得3枚“败甲”标记。②当你失去一张装备牌后，你失去1枚“败甲”标记。③出牌阶段限一次，你可以摸三张牌，然后你可以使用一张【杀】。本阶段你使用下X张手牌时弃置一张牌（X为你此时拥有的“败甲”标记数）；本阶段结束时，若你本阶段未因此法弃置过非装备牌，则你可以视为使用一张无距离限制的【杀】。",
	ol_zhaozhong: "赵忠",
	olpengbi: "朋比",
