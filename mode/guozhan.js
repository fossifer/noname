	...
	return {
		...
		characterPack: {
			mode_guozhan: {
				...
				gz_ol_sb_sunjian: ["male", "wu", "4/5", ["olsbhulie", "olsbyipo"]],
		...
		translate: {
			...
			fakequanji: "权计",
			fakequanji_info: "①每回合每项各限一次，当你造成或受到伤害后，你可以摸X张牌（至多为体力上限），然后将等量的牌称为“权”置于武将牌上。②你的手牌上限+X（X为你武将牌上的“权”数）。",
			fakepaiyi: "排异",
			...
			gz_ol_sb_sunjia: "OL谋孙坚",
			gz_ol_sb_sunjia_prefix: "OL谋",
			gzguishu: "鬼术",
